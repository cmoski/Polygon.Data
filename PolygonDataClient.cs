...
namespace Polygon.Data
{
    ...
    public sealed class PolygonDataClient : IPolygonDataClient
    {
        ...
        /// <inheritdoc />
        public Task<IReadOnlyList<INewsItem>> GetTickerNews(string symbol, int perpage=50, int page=1,
            CancellationToken cancellationToken = default) =>
            _httpClient.GetAsync<IReadOnlyList<INewsItem>, List<JsonPolygonNews>>(
                GetUriBuilder($"v1/meta/symbols/{symbol}/news"), cancellationToken);
